...
class ReturnNumericActions(BaseActions):
    """ Returns numeric value passed as parameter
    """
    def __init__(self, _):
        pass

    @rule_action(params={'return_value': fields.FIELD_NUMERIC})
    def return_numeric(self, return_value):
        return return_value


class ReturnTextActions(BaseActions):
    """ Returns string value passed as parameter
    """
    def __init__(self, _):
        pass

    @rule_action(params={'return_value': fields.FIELD_TEXT})
    def return_text(self, return_value):
        return return_value