...
class IntegrationTests(TestCase):
    ...
    def test_export_rule_data(self):
        ...
        self.assertEqual(all_data.get("variable_type_operators"),
                         {'boolean': [{'name': 'is_false', 'label': 'Is False', 'input_type': 'none'},
                                      {'name': 'is_true', 'label': 'Is True', 'input_type': 'none'}],
                          'datetime': [{'name': 'equal_to', 'label': 'Equal To', 'input_type': 'text'},
                                       {'name': 'greater_equal_than', 'label': 'Greater Equal Than',
                                        'input_type': 'text'},
                                       {'name': 'greater_than', 'label': 'Greater Than', 'input_type': 'text'},
                                       {'name': 'less_equal_than', 'label': 'Less Equal Than', 'input_type': 'text'},
                                       {'name': 'less_than', 'label': 'Less Than', 'input_type': 'text'},
                                       {'name': 'not_equal_to', 'label': 'Not Equal To', 'input_type': 'text'}],
                          'numeric_list': [{'name': 'contains_all', 'label': 'Contains All', 'input_type': 'numeric'},
                                           {'name': 'contains_at_least_one_element',
                                            'label': 'Contains At Least One Element', 'input_type': 'numeric'}],
                          'numeric': [{'name': 'equal_to', 'label': 'Equal To', 'input_type': 'numeric'},
                                      {'name': 'greater_than', 'label': 'Greater Than', 'input_type': 'numeric'},
                                      {'name': 'greater_than_or_equal_to', 'label': 'Greater Than Or Equal To',
                                       'input_type': 'numeric'},
                                      {'name': 'less_than', 'label': 'Less Than', 'input_type': 'numeric'},
                                      {'name': 'less_than_or_equal_to', 'label': 'Less Than Or Equal To',
                                       'input_type': 'numeric'}], 'select_multiple': [
                             ...
                             {'name': 'shares_at_least_one_element_with', 'label': 'Shares At Least One Element With',
                              'input_type': 'select_multiple'},
                             {'name': 'shares_exactly_one_element_with', 'label': 'Shares Exactly One Element With',
                              'input_type': 'select_multiple'},
                             {'name': 'shares_no_elements_with', 'label': 'Shares No Elements With',
                              'input_type': 'select_multiple'}],
                          'select': [{'name': 'contains', 'label': 'Contains', 'input_type': 'select'},
                                     {'name': 'does_not_contain', 'label': 'Does Not Contain', 'input_type': 'select'}],
                          'string_list': [{'name': 'contains_all', 'label': 'Contains All', 'input_type': 'text'},
                                          {'name': 'contains_at_least_one_element',
                                           'label': 'Contains At Least One Element', 'input_type': 'text'}],
                          'string': [{'name': 'contains', 'label': 'Contains', 'input_type': 'text'},
                                     ...
                                     {'name': 'equal_to_case_insensitive', 'label': 'Equal To (case insensitive)',
                                      'input_type': 'text'},
